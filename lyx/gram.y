...
/* SQL */
/* generated */
%token<str> FOLLOWING ROWS ROLLUP CUBE PRECEDING NOT_LA LIKE UNION Op UNBOUNDED RANGE PARTITION UMINUS IN_P INTERSECT GROUPS OPERATOR EXCEPT BETWEEN ILIKE SIMILAR TYPECAST AT 
