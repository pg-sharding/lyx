...
const lexer_en_singleQuoteString int = 640
...
{ 
                lval.str = ""
                {( lex.stack)[( lex.top)] = 9; ( lex.top)++; goto st640 }
            }
	goto st9
tr19:
