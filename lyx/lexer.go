...
const lexer_en_singleQuoteString int = 598
...
{ 
                lval.str = ""
                {( lex.stack)[( lex.top)] = 8; ( lex.top)++; goto st598 }
            }
	goto st8
tr18:
