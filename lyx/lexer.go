...
const lexer_en_singleQuoteString int = 596
...
{ 
                lval.str = ""
                {( lex.stack)[( lex.top)] = 8; ( lex.top)++; goto st596 }
            }
	goto st8
tr18:
