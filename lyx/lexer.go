...
const lexer_en_singleQuoteString int = 610
...
{ 
                lval.str = ""
                {( lex.stack)[( lex.top)] = 8; ( lex.top)++; goto st610 }
            }
	goto st8
tr18:
