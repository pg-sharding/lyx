...
//line NONE:1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = SCONST; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 7:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CAST; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 8:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = AT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 9:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = WITHOUT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 36:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = TIMESTAMP; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 37:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = TYPE_P; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 38:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = ENUM_P; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 39:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = PREPARE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 43:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = OPERATOR; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 44:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = COLLATE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 45:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = TABLE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 56:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = EXTENSION; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 57:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = SCHEMA; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 58:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = PRIMARY; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 61:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = UNIQUE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 62:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CONSTRAINT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 63:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CONCURRENTLY; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 64:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = FOREIGN; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 65:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CHECK; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 66:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = KEY; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 69:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = RESET; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 70:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = AND; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 80:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = GRANT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 81:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = REVOKE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 82:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = COPY; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 86:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = EXTRACT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 87:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = LIMIT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 90:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = OFFSET; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 91:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = DISTINCT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 92:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = LIKE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 93:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = ILIKE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 95:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = NULLS_LA; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 99:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = NORMALIZE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 100:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = FALSE_P; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 106:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = FETCH; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 107:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = FIRST_P; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 108:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = FILTER; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 109:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = SESSION; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 113:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = LOCAL; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 114:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CURRENT_USER; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 115:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = COMMITTED; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 120:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CASCADE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 121:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = RESTRICT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 122:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = ARRAY; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 124:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = ROWS; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 125:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = EXISTS; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 126:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = DISCARD; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 127:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = PLANS; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 128:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = SEQUENCES; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 129:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = NAMES; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 130:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = DEPTH; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 147:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = SHARE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 148:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = USING; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 149:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = BEGIN; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 168:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = SAVEPOINT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 169:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = ELSE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 170:
	{( lex.p) = ( lex.te) - 1
 ...
 lval.str = string(lex.data[lex.ts:lex.te]); tok = ROLLBACK; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 187:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CASE; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 188:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = WHEN; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 189:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = THEN; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 191:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CONFLICT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 193:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = NOTHING; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 195:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = UNION; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 196:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = EXCEPT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 197:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = INTERSECT; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 198:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = ALL; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 199:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = PARTITION; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 200:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = OVER; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 201:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = CONVERSION_P; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 202:
	{( lex.p) = ( lex.te) - 1
 lval.str = string(lex.data[lex.ts:lex.te]); tok = STATISTICS; {( lex.p)++;  lex.cs = 10; goto _out }}
	case 204:
	{( lex.p) = ( lex.te) - 1
...
( lex.p)--
{
                ...
                if v, err := strconv.ParseInt(inp, 10, 64); err != nil {
                    lval.int = 0; tok = INVALID_ICONST; {( lex.p)++;  lex.cs = 10; goto _out }
                } else {
                    lval.int = v; tok = PARAM; {( lex.p)++;  lex.cs = 10; goto _out }
                }
            }
	goto st10
tr68:
...
{ 
                ...
                if v, err := strconv.ParseInt(inp, 10, 64);  err != nil {
                    /* tooo big */
                    lval.str = inp; tok = SCONST; {( lex.p)++;  lex.cs = 10; goto _out }
                } else {
                    lval.int = v; tok = ICONST; {( lex.p)++;  lex.cs = 10; goto _out }
                }
            }
	goto st10
tr74:
...
//line lyx/lexer.rl:355
 lex.te = ( lex.p)
( lex.p)--
{ lval.str = string(lex.data[lex.ts:lex.te]); tok = DO; {( lex.p)++;  lex.cs = 10; goto _out }}
	goto st10
tr393:
...
//line lyx/lexer.rl:169
 lex.te = ( lex.p)
( lex.p)--
{ lval.str = string(lex.data[lex.ts:lex.te]); tok = OF; {( lex.p)++;  lex.cs = 10; goto _out }}
	goto st10
tr561:
...
//line lyx/lexer.go:4131
	...
	_test_eof616:  lex.cs = 616; goto _test_eof
	_test_eof617:  lex.cs = 617; goto _test_eof
	_test_eof618:  lex.cs = 618; goto _test_eof
	_test_eof619:  lex.cs = 619; goto _test_eof
	_test_eof620:  lex.cs = 620; goto _test_eof
	_test_eof621:  lex.cs = 621; goto _test_eof
	_test_eof622:  lex.cs = 622; goto _test_eof
	_test_eof623:  lex.cs = 623; goto _test_eof
	_test_eof624:  lex.cs = 624; goto _test_eof
	_test_eof625:  lex.cs = 625; goto _test_eof
	_test_eof626:  lex.cs = 626; goto _test_eof
	_test_eof627:  lex.cs = 627; goto _test_eof
	_test_eof628:  lex.cs = 628; goto _test_eof
	_test_eof629:  lex.cs = 629; goto _test_eof
	_test_eof630:  lex.cs = 630; goto _test_eof
	_test_eof631:  lex.cs = 631; goto _test_eof
	_test_eof632:  lex.cs = 632; goto _test_eof
	_test_eof633:  lex.cs = 633; goto _test_eof
	_test_eof634:  lex.cs = 634; goto _test_eof
	_test_eof635:  lex.cs = 635; goto _test_eof
	_test_eof636:  lex.cs = 636; goto _test_eof
	_test_eof637:  lex.cs = 637; goto _test_eof
	_test_eof638:  lex.cs = 638; goto _test_eof
	_test_eof639:  lex.cs = 639; goto _test_eof
	_test_eof640:  lex.cs = 640; goto _test_eof
