...
const lexer_en_singleQuoteString int = 621
...
{ 
                lval.str = ""
                {( lex.stack)[( lex.top)] = 8; ( lex.top)++; goto st621 }
            }
	goto st8
tr18:
