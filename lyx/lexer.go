...
const lexer_en_singleQuoteString int = 602
...
{ 
                lval.str = ""
                {( lex.stack)[( lex.top)] = 8; ( lex.top)++; goto st602 }
            }
	goto st8
tr18:
